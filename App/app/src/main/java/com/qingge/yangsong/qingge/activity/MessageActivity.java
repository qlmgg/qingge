...
import com.qingge.yangsong.qingge.fragments.message.ChatGroupFragment;
import com.qingge.yangsong.qingge.fragments.message.ChatUserFragment;

//import net.qiujuer.italker.factory.model.Author;

/**
 *这个界面不用了 ,点击用户或者群头像时直接进入对应的Activity   以后项目完成后再删除
 */
