package com.qingge.yangsong.factory;
...
import com.qingge.yangsong.factory.data.school.SchoolDispatcher;
...
//                    getGroupCenter().dispatch(card.toArray(new GroupMemberCard[0]));
     ...
     * @return 用户中心的规范接口
     */
    public static PostCenter getPostCenter() {
        return PostDispatcher.instance();
    }
     ...
     * @return 用户中心的规范接口
     */
    public static SchoolCenter getSchoolCenter() {
        return SchoolDispatcher.instance();
    }
