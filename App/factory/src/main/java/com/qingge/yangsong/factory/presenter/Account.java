...
public class Account {
    ...
    private static final String KEY_USER_SCHOOL_ID = "KEY_USER_SCHOOL_ID";
...
//        schoolId = sp.getString(KEY_USER_SCHOOL_ID, "");
...
//    }
    ...
    public static User getSelf() {
        // 返回自己
        return TextUtils.isEmpty(userId) ? null : SQLite.select()
                .from(User.class)
                .where(User_Table.id.eq(userId))
                .querySingle();
    }
