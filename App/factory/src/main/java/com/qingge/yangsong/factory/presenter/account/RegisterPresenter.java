...
public class RegisterPresenter extends BaseActivityPresenter<RegisterContract.View>
    ...
    @Override
    public void register(String phone, String password, String name,String schoolName) {
        start();

        RegisterModel registerModel = new RegisterModel(phone, password, name, Account.getPushId(),schoolName);
