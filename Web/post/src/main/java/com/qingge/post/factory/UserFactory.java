...
public class UserFactory {
     ...
     * @return User
     */
    public static User register(String account, String password, String name, String schoolName) {
        ...
        User user = createUser(account, password, name, schoolName);
        if (user != null) {
            user = login(user);
        }
        return user;
     ...
     * @return 返回一个用户
     */
    private static User createUser(String account, String password, String name, String schoolName) {
        User user = new User();
        user.setName(name);
